      ...
      <div className="w-full max-w-2xl mx-auto -36 p-16">
        <Card>
          <CardContent className="p-4">
            <Button onClick={() => fileInputRef.current.click()} className="mb-4 flex items-center gap-2">
              <UploadCloud size={16} />
                ...
                <div className="relative h-full" style={{ padding: `${gap}px` }}>
                  {images.map((image, index) => (
                    <div
                      ...
                      className="absolute"
                      style={{
                        top: `${(index < 2 ? splits.horizontal : 100 - splits.horizontal)}%`,
                        left: `${(index % 2 === 0 ? splits.vertical : 100 - splits.vertical)}%`,
                        width: `${(index % 2 === 0 ? 100 - splits.vertical : splits.vertical)}%`,
                        height: `${(index < 2 ? 100 - splits.horizontal : splits.horizontal)}%`,
                        padding: `${gap}px`,
                      }}
                    >
